...
@section('js')
    ...
    <script>
        ...
        $('.filter').click(function(){
            ...
            if(sortby)
            {
               document.location = APP_URL + '/search/member/{{ $query }}?categories=' + categories.join(",") + "&sortby=" + sortby ;
            }
            else
            {
               document.location = APP_URL + '/search/member/{{ $query }}?categories=' + categories.join(",");
            }
        })
    </script>
