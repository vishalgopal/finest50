                                        ...
                                        <div class="d-flex align-items-center mr-2">
                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                <div class="symbol-label">
                                                    <img src="{{ $follower->avatar }}" alt="{{ $follower->name }}" class="h-75" />
                                                </div>
                                            </div>
                                            <div>
                                                <a href="{{ URL::to('member/'.$follower->slug) }}" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">{{ $follower->name }}</a>
