                            ...
                            <form method="POST" enctype="multipart/form-data" id="blog-post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-5">
                                        ...
                                        <div class="dropzone dropzone-default" id="myDropzone" name="image">
                                            <img src="{{ asset('img/large/' . $blog->image) }}" >
                                        </div>
        ...
        <script>
            ...
            $('.submit-btn').click(function () {
                ...
                if (title != "") {
                    ...
                    $.ajax({
                        type: 'post',
                        url: APP_URL + '/blog/update/' + blogid,
                        data: {
            ...
            $(document).ready(function (e) {
                ...
                $('#blog-post').submit(function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: APP_URL + '/blog/update/' + {{ $blog->id }},
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
