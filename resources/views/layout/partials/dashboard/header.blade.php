							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="topbar-item mr-3" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-light btn-dropdown btn-lg pulse pulse-primary">
										...
										<form>
											...
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
												...
												<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
													<li class="nav-item">
														<a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">Comments</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">Reviews</a>
													</li>
													<li class="nav-item">
													...
													<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex flex-column font-weight-bold">
																<a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Lorem ipsum</a>
																<span class="text-muted">Lorem ipsum Lorem ipsum</span>
															</div>
															<!--end::Text-->
														</div>
														<!--end::Item-->
													...
													<div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
														...
														<a href="#" class="navi-item">
															<div class="navi-link">
																...
																<div class="navi-text">
																	<div class="font-weight-bold">Lorem ipsum dolor sit amet, consectetur</div>
														...
														<a href="#" class="navi-item">
															<div class="navi-link">
																...
																<div class="navi-text">
																	<div class="font-weight-bold">Lorem ipsum dolor sit amet, consectetur generated</div>
																	<div class="text-muted">25 hrs ago</div>
																</div>
															</div>
														</a>
								...
								<div class="topbar-item">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										<div class="d-flex flex-column text-right pr-3">
											<span class="text-muted font-weight-bold font-size-base d-none d-md-inline">{{ $user->name }}</span>
											<span class="text-dark-75 font-weight-bolder font-size-base d-none d-md-inline">@if($user->designation!=""){{ $user->designation }}@endif</span>
										</div>
