...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <!--end:Item-->
            <!--begin::Item-->
            <a href="{{ URL::to('dashboard/chat') }}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">My Chat</div>
                        <div class="text-muted">Chat with Members</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
            <!--begin::Item-->
            <a href="{{ URL::to('dashboard/timeline') }}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">My Timeline</div>
                        <div class="text-muted">View what member you follow are doing </div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
